...
namespace WizardBase
{
    ...
    public class WizardControl : Control
    {
        ...
        private void InitializeComponent()
        {
            ...
            BackButton.UseCompatibleTextRendering = true;
            ...
            EulaLabel.UseCompatibleTextRendering = true;
            ...
            HelpButton.UseCompatibleTextRendering = true;
        ...
        public virtual void OnNextButtonClick(object sender, EventArgs e)
        {
            int num;
            if (DesignMode)
            {
